...
public class HYDimensions {
    private final static String CLASS_NAME = "HYDimensions";
    ...
    public final static DeferredHolder<DimensionType, DimensionType> DEBUG_DIM02 =
            DR_TYPE.register("debug_dim02", () -> debugDim02.DE_DIMENSION_TYPE);
    ...
    public static Collection<DeferredHolder<DimensionType, ? extends DimensionType>> register(MinecraftServer server) {
        ...
        DimensionType debugDimensionType = debugDim02.DE_DIMENSION_TYPE;
        ...
        flatSettings = flatSettings.withBiomeAndLayers(debugDim02.FLAT_LAYER_INFOS, structures, biomeHolder);
