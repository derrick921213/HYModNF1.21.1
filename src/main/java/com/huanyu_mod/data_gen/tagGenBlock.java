...
public class tagGenBlock extends BlockTagsProvider {
    public tagGenBlock(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper) {
