...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        tagGenBlock _tagGenBlock =
                generator.addProvider(event.includeServer(), new tagGenBlock(packOutput, lookupProvider, existingFileHelper));
        generator.addProvider(event.includeServer(), new tagGenItem(packOutput, lookupProvider, _tagGenBlock.contentsGetter(), existingFileHelper));
        ...
        generator.addProvider(event.includeServer(), new worldGenerate(packOutput, lookupProvider));
    }
}