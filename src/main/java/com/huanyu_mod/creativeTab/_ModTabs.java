...
public class _ModTabs {
    ...
    public static void addCreative(BuildCreativeModeTabContentsEvent event) {
        if(event.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES) {
            event.accept(_ModItems.DEBUG_ITEM00);
        }
    }
    ...
    public static final Supplier<CreativeModeTab> DEBUG_TAB00 = DR_TABS.register(
            ...
            () -> CreativeModeTab.builder()
                    ...
                    .icon(() -> new ItemStack(_ModItems.DEBUG_ITEM00.get()))
                    .displayItems((itemDisplayParameters, output) -> {
                        output.accept(_ModItems.DEBUG_ITEM00);
                        output.accept(_ModItems.DEBUG_ITEM01);
                        output.accept(_ModItems.DEBUG_ITEM02);
                        output.accept(_ModBlocks.DEBUG_BLOCK00);
                        output.accept(_ModBlocks.DEBUG_BLOCK01);
                        output.accept(_ModBlocks.DEBUG_BLOCK02);
                    })
                    .build()
    );
    public static final Supplier<CreativeModeTab> DEBUG_TAB01 = DR_TABS.register(
            ...
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        output.accept(_ModBlocks.DIMENSION_EDITOR);
                    })
                    .build()
    );
}
